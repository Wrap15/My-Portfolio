  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 rounded-[24px] overflow-hidden z-15">
        <div className="absolute top-[-50%] bottom-[-50%] w-[45%] -translate-x-full rotate-[25deg] bg-gradient-to-r from-transparent via-white/20 dark:via-emerald-400/[0.08] to-transparent transition-transform duration-1000 ease-[cubic-bezier(0.16,1,0.3,1)] md:group-hover:translate-x-[300%]" />
      </div>
